...
> **Purpose**: This document defines the ID generation strategy used throughout the application.
 ...
 * 
 * @param operation - Function that performs the insert
 * @param maxRetries - Maximum retry attempts (default: 3)
 * @returns Result of the operation
 * 
 * @example
 * const user = await withRetryOnCollision(async () => {
...
## 7. Application-Side Generation (When Needed)
